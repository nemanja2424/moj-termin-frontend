      ...
      <header className={styles.header}>
        <div className={styles.brandFirme}>
          {forma.logoFirme === true && 
            <img loading='lazy' className={styles.logo} src={preduzece.putanja_za_logo === '/Images/logo.webp' ? '/Images/logo.webp' : `http://127.0.0.1:5000/api/logo/${preduzece.putanja_za_logo}`} />
          }
